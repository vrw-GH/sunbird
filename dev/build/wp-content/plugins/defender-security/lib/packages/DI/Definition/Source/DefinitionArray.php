...
/**
 * Reads WPMU_DEV\Defender\Vendor\DI definitions from a PHP array.
 *
...
class DefinitionArray implements DefinitionSource, MutableDefinitionSource
{
    ...
    /**
     * WPMU_DEV\Defender\Vendor\DI definitions in a PHP array.
     * @var array
     */
    private $definitions = [];
    ...
    public function __construct(array $definitions = [], Autowiring $autowiring = null)
    {
        if (isset($definitions[0])) {
            throw new \Exception('The PHP-WPMU_DEV\Defender\Vendor\DI definition is not indexed by an entry name in the definition array');
        }
    ...
    /**
     * @param array $definitions WPMU_DEV\Defender\Vendor\DI definitions in a PHP array indexed by the definition name.
     */
