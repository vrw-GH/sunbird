...
use WPMU_DEV\Defender\Vendor\DI\Compiler\Compiler;
use WPMU_DEV\Defender\Vendor\DI\Definition\Source\AnnotationBasedAutowiring;
use WPMU_DEV\Defender\Vendor\DI\Definition\Source\DefinitionArray;
use WPMU_DEV\Defender\Vendor\DI\Definition\Source\DefinitionFile;
use WPMU_DEV\Defender\Vendor\DI\Definition\Source\DefinitionSource;
use WPMU_DEV\Defender\Vendor\DI\Definition\Source\NoAutowiring;
use WPMU_DEV\Defender\Vendor\DI\Definition\Source\ReflectionBasedAutowiring;
use WPMU_DEV\Defender\Vendor\DI\Definition\Source\SourceCache;
use WPMU_DEV\Defender\Vendor\DI\Definition\Source\SourceChain;
...
class ContainerBuilder
{
    ...
    /**
     * If PHP-WPMU_DEV\Defender\Vendor\DI is wrapped in another container, this references the wrapper.
    ...
    public function build()
    {
        ...
        if ($this->sourceCache) {
            if (!SourceCache::isSupported()) {
                throw new \Exception('APCu is not enabled, PHP-WPMU_DEV\Defender\Vendor\DI cannot use it as a cache');
            }
     ...
     * set this so that PHP-WPMU_DEV\Defender\Vendor\DI will use the wrapper rather than itself for building objects.
     *
     * @return $this
     */
     ...
     *   PHP-WPMU_DEV\Defender\Vendor\DI knows about them and compiles them
