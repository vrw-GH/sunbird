<?php
/**
 * This template is used to generate an email for audit report.
 *
 * @package WP_Defender
 */
...
<table class="reports-list" align="center"
	...
	<tbody>
	<?php foreach ( $collection as $event_type => $arr_events ) : ?>
		<?php foreach ( $arr_events as $action_type => $frequency ) : ?>
			<tr class="report-list-item"
				...
				<td class="report-list-item-info"
					style="border-collapse: collapse !important;color: #1A1A1A;font-family: Roboto, Arial, sans-serif;font-size: 13px;font-weight: 500;letter-spacing: -0.25px;line-height: 21px;margin: 0;min-width: 65px;padding: 18px 0;text-align: left;vertical-align: top">
					<span style="color: inherit; display: inline; font-size: inherit; font-family: inherit; line-height: inherit; vertical-align: middle;letter-spacing: -0.25px;padding-right: 20px;"><?php echo esc_html( ucfirst( $action_type ) ); ?></span>
				</td>
				<td class="report-list-item-info"
