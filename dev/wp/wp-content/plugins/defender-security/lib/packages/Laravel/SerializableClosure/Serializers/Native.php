...
namespace WPMU_DEV\Defender\Vendor\Laravel\SerializableClosure\Serializers;

use Closure;
use DateTimeInterface;
use WPMU_DEV\Defender\Vendor\Laravel\SerializableClosure\Contracts\Serializable;
use WPMU_DEV\Defender\Vendor\Laravel\SerializableClosure\SerializableClosure;
use WPMU_DEV\Defender\Vendor\Laravel\SerializableClosure\Support\ClosureScope;
use WPMU_DEV\Defender\Vendor\Laravel\SerializableClosure\Support\ClosureStream;
use WPMU_DEV\Defender\Vendor\Laravel\SerializableClosure\Support\ReflectionClosure;
use WPMU_DEV\Defender\Vendor\Laravel\SerializableClosure\Support\SelfReference;
use WPMU_DEV\Defender\Vendor\Laravel\SerializableClosure\UnsignedSerializableClosure;
...
class Native implements Serializable
{
     ...
     *
     * @var \WPMU_DEV\Defender\Vendor\Laravel\SerializableClosure\Support\ReflectionClosure|null
     */
    protected $reflector;
     ...
     * The closure's scope.
     *
     * @var \WPMU_DEV\Defender\Vendor\Laravel\SerializableClosure\Support\ClosureScope|null
     */
    protected $scope;
     ...
     *
     * @param  mixed  $data
     * @param  \WPMU_DEV\Defender\Vendor\Laravel\SerializableClosure\Support\ClosureScope  $storage
     * @return void
     */
     ...
     *
     * @return \WPMU_DEV\Defender\Vendor\Laravel\SerializableClosure\Support\ReflectionClosure
     */
