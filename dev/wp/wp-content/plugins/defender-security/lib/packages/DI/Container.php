...
use WPMU_DEV\Defender\Vendor\DI\Definition\Resolver\ResolverDispatcher;
use WPMU_DEV\Defender\Vendor\DI\Definition\Source\DefinitionArray;
use WPMU_DEV\Defender\Vendor\DI\Definition\Source\MutableDefinitionSource;
...
use WPMU_DEV\Defender\Vendor\DI\Invoker\DefinitionParameterResolver;
...
use WPMU_DEV\Defender\Vendor\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
...
class Container implements ContainerInterface, FactoryInterface, InvokerInterface
{
     ...
     *                             The array can also contain WPMU_DEV\Defender\Vendor\DI definitions, e.g. WPMU_DEV\Defender\Vendor\DI\get().
     *
