...
use WPMU_DEV\Defender\Vendor\DI\Annotation\Inject;
use WPMU_DEV\Defender\Vendor\DI\Annotation\Injectable;
use WPMU_DEV\Defender\Vendor\DI\Definition\Exception\InvalidAnnotation;
use WPMU_DEV\Defender\Vendor\DI\Definition\ObjectDefinition;
use WPMU_DEV\Defender\Vendor\DI\Definition\ObjectDefinition\MethodInjection;
use WPMU_DEV\Defender\Vendor\DI\Definition\ObjectDefinition\PropertyInjection;
use WPMU_DEV\Defender\Vendor\DI\Definition\Reference;
use Doctrine\Common\Annotations\AnnotationRegistry;
use Doctrine\Common\Annotations\Reader;
use Doctrine\Common\Annotations\SimpleAnnotationReader;
use InvalidArgumentException;
use WPMU_DEV\Defender\Vendor\PhpDocReader\PhpDocReader;
use ReflectionClass;
...
/**
 * Provides WPMU_DEV\Defender\Vendor\DI definitions by reading annotations such as @ Inject and @ var annotations.
 *
...
class AnnotationBasedAutowiring implements DefinitionSource, Autowiring
{
    ...
    /**
     * @var WPMU_DEV\Defender\Vendor\PhpDocReader
     */
    ...
    private function readProperty(ReflectionProperty $property, ObjectDefinition $definition, $classname = null)
    {
        ...
        $annotation = $this->getAnnotationReader()->getPropertyAnnotation($property, 'WPMU_DEV\Defender\Vendor\DI\Annotation\Inject');
    ...
    private function getMethodInjection(ReflectionMethod $method)
    {
        // Look for @Inject annotation
        try {
            $annotation = $this->getAnnotationReader()->getMethodAnnotation($method, 'WPMU_DEV\Defender\Vendor\DI\Annotation\Inject');
    ...
    public function getAnnotationReader()
    {
        if ($this->annotationReader === null) {
            ...
            $this->annotationReader->addNamespace('WPMU_DEV\Defender\Vendor\DI\Annotation');
        }
    ...
    /**
     * @return WPMU_DEV\Defender\Vendor\PhpDocReader
     */
    ...
    private function readInjectableAnnotation(ReflectionClass $class, ObjectDefinition $definition)
    {
        try {
            ...
            $annotation = $this->getAnnotationReader()
                ->getClassAnnotation($class, 'WPMU_DEV\Defender\Vendor\DI\Annotation\Injectable');
