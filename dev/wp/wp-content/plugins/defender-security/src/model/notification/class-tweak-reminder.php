...
class Tweak_Reminder extends \WP_Defender\Model\Notification {
	...
	protected function before_load(): void {
		$params = array(
			'slug'                 => self::SLUG,
			'title'                => esc_html__( 'Security Recommendations - Notification', 'defender-security' ),
	...
	public function send_to_user( $email, $name, $issues, $service ) {
		...
		$content          = $security_tweak->render_partial(
			'email/index',
			array(
				'title'            => esc_html__( 'Security Report', 'defender-security' ),
	...
	public function labels(): array {
		return array(
			'notification'        => esc_html__( 'Security Recommendations - Notification', 'defender-security' ),
